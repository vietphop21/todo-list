    ...
    <>
      ...
      <div className="todo">
        <div className="tdl1">
          ...
          <Input
            ref={inputRef}
            style={{ width: "400px", borderRadius: "7px 0px 0px 7px" }}
            className="todo-input"
            placeholder="Nhập thêm công việc cần làm !!!"
            value={work}
          ...
          {show === true ? (
            <Button
              style={{ marginRight: "20px", borderRadius: "0px 10px 10px 0px" }}
              type="primary"
